...
const Ul = ({ index, data ,deleteFunction , editFunction}) => {
  ...
  return (
    <div className="flex justify-between items-center group relative bg-slate-200 mt-5" key={index}>
      <li key={index} className="text-left text-3xl w-full py-8 px-2 overflow-hidden text-ellipsis whitespace-nowrap group-hover:w-3/4 transition-width duration-10"> {data} </li>
      <div className="hidden group-hover:block absolute right-0 top-16">
